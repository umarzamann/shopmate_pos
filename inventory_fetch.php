          ...
          <tbody>
            ...
            <tr class="text-center">
              ...
              <td>
                ...
                <a class="btn btn-primary btn-scale px-4" href='update_user.php?uid=<?php echo $row['uid']; ?>'>Edit</a>
                <span class="d-flex justify-content-center align-items-center text-muted fw-bold">|</span>
                  <a class="btn btn-danger btn-scale px-3" onclick="confirmDeletion(<?= $row['uid']; ?>)" >Delete</a>
                </div>  
            </td>
            </tr>
            <?php } ?>
